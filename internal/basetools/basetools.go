...
// list what is there, read one, describe a kind's fields, find out where a
// service is offered, find out how much of the quota is left — is the same work
// for every service on the platform, and a platform that makes each provider
// build it again gets a different answer from each of them.
//
...
const (
	...
	// LocationsListToolName lists where a service is offered to this project.
	LocationsListToolName = "locations_list"
	// QuotaGetToolName reports what a project's allowance has left.
	QuotaGetToolName = "quota_get"
)
