...
import (
	v1alpha1 "github.com/milo-os/assistant/pkg/apis/assistant/v1alpha1"
...
func schema_pkg_apis_assistant_v1alpha1_CapabilityGapReportEvidence(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "CapabilityGapReportEvidence quotes the offending tool output so the provider's team can check the claim. It carries tool output and object state only — never text from the user's message.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"tool": {
						SchemaProps: spec.SchemaProps{
							Description: "Tool is the tool whose output was at fault, e.g. \"workloads_list\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"observed": {
						SchemaProps: spec.SchemaProps{
							Description: "Observed is what that tool returned, e.g. \"actionability: transient\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"contradictedBy": {
						SchemaProps: spec.SchemaProps{
							Description: "ContradictedBy is the fact that makes Observed wrong, thin, or impossible to act on, e.g. \"instance unchanged for 9d\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"kind": {
						SchemaProps: spec.SchemaProps{
							Description: "Kind classifies the shortfall. Reports stored before kinds existed read back as MissingCapability.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"evidence": {
						SchemaProps: spec.SchemaProps{
							Description: "Evidence quotes the tool output a non-MissingCapability report is about. Absent when there is nothing to quote.",
							Ref:         ref(v1alpha1.CapabilityGapReportEvidence{}.OpenAPIModelName()),
						},
					},
				},
			},
...
func schema_pkg_apis_assistant_v1alpha1_ConversationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.Conversation{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.Conversation{}.OpenAPIModelName(), v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_pkg_apis_assistant_v1alpha1_ConversationMessage(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ConversationMessage is a single stored message in a conversation.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"seq": {
						SchemaProps: spec.SchemaProps{
				...
				Required: []string{"seq", "role", "content", "createdAt"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_assistant_v1alpha1_ConversationMessages(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ConversationMessages is the object returned by the `conversations/messages` subresource — the full transcript embedded.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "Name/Namespace echo the parent conversation.",
							Default:     map[string]interface{}{},
							Ref:         ref(v1.ObjectMeta{}.OpenAPIModelName()),
						},
					},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.ConversationMessage{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.ConversationMessage{}.OpenAPIModelName(), v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_pkg_apis_assistant_v1alpha1_ConversationStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ConversationStatus reports rollup information about a conversation.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"lastActiveAt": {
						SchemaProps: spec.SchemaProps{
							Description: "LastActiveAt is the timestamp of the most recent message.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"messageCount": {
						SchemaProps: spec.SchemaProps{
							Description: "MessageCount is the number of stored messages.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
