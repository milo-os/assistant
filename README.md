...
- [**Configuration & auth**](docs/configuration.md) — environment
  variables, model modes, OIDC / SubjectAccessReview.
...
and task store on PostgreSQL, gateway-metered billing, OIDC + fail-closed
SubjectAccessReview authorization, and a production deployment overlay.
